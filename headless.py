...
def main():
    ...
    MESH_MENU = (
        "Welcome to the MeshUpGrade Radio Network! Just text us the 1, 2, 3, or 4-letter name of the radio you want to reach. When you're done chatting, reply ENDCONVO to stop the current conversation. Reply MENU to see this message again"
    )
    ...
    # Disabled generic APRS RX loop to prevent duplicate-login conflicts with SMS Gateway priority
